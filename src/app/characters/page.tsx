...
import { Plus, User, ArrowLeft, Search, Filter, Hash, Tag, Trash2, Edit2, ChevronDown, X } from 'lucide-react';
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex flex-wrap gap-1 mt-1">
                                        {char.groupIds?.map(gid => {
                                            ...
                                            return g ? (
                                                <span key={gid} className="text-[9px] font-black uppercase tracking-tighter px-1.5 py-0.5 rounded bg-zinc-900 border border-zinc-800 text-zinc-500">
                                                    {g.name}
                                                </span>
                                            ) : null;
                                        })}
                                        <button className="text-[9px] font-black uppercase px-2 py-0.5 rounded bg-zinc-900/50 text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800 transition-colors border border-transparent hover:border-zinc-700">
                                            + グループ割り当て
                                        </button>
                                    </div>
                                </div>
